...
void RaySpaceTree::constructSmartRandom(glm::ivec2 res, std::vector<Orthocamera>& cams,
...
void RaySpaceTree::constructSmartRandom(int level, Node* node, glm::ivec2 res, std::vector<Orthocamera>& cams,
