...
public:
	...
	void getSplittingLinesInLeaf(int leafnum, std::vector<Split>& lines);
	void getSplittingLinesInNode(Node* n, std::vector<Split>& lines);
	void getSplittingLinesInNodeWithSide(Node* n, std::vector<SplitSide>& lines);
